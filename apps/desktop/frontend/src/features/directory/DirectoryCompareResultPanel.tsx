...
import type { CompareDirectoriesResponse, DirectoryCompareItem } from '../../types'
...
export type DirectoryCompareResultPanelProps = {
  ...
  sortedDirectoryItems: DirectoryCompareItem[]
  flattenedDirectoryTreeRows: DirectoryTreeRow[]
  selectedDirectoryItemForDetail: DirectoryCompareItem | null
  ...
  onOpenDirectoryEntryDiff: (item: DirectoryCompareItem) => void | Promise<void>
  onToggleDirectoryTreeNode: (node: DirectoryTreeNode) => void | Promise<void>
  onDirectoryRowDoubleClick: (item: DirectoryCompareItem) => void | Promise<void>
...
export function DirectoryCompareResultPanel({
  ...
  const canCompareDirectories = !!directoryLeftRoot && !!directoryRightRoot
                  ...
                  <Fragment key={crumb.path || 'root'}>
                    {crumb.path === currentPath ? (
                      ...
                      <button
                        ...
                        disabled={loading || !canCompareDirectories}
                      >
                        {crumb.label}
                      </button>
                    )}
        ...
        {shouldShowDirectoryDetail ? (
          <div className="directory-detail-pane directory-detail-card">
            ...
            <div className="directory-detail-grid">
              ...
              <div>{selectedDirectoryItemForDetail.compareModeHint}</div>
