# Directory Fixture: filters

This fixture validates the filter workflow in Directory Compare with
a wider mix of files across `src/`, `docs/`, and `tests/`.

## Left root

`examples/directory/filters/left`

## Right root

`examples/directory/filters/right`
